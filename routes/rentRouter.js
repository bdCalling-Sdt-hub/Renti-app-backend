...
const { createRentRequest, acceptRentRequest, allRentRequest, getRentById, updateRentById, deleteRentById, startTrip, hostRentList, gethostRentById, userCancelRentRequest, userWiseAllRentRequest } = require('../controllers/rentController');
...
router.get('/rent-history', isValidUser, userWiseAllRentRequest);
