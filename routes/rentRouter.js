...
const { createRentRequest, acceptRentRequest, allRentRequest, getRentById, updateRentById, deleteRentById, startTrip, hostRentList, gethostRentById } = require('../controllers/rentController');
